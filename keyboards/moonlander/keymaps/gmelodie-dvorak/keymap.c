...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_TAB,         KC_SLASH, KC_COMMA,  KC_DOT,           KC_P,           KC_Y,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_F,       KC_G,           KC_C,           KC_R,           KC_L,           KC_TRANSPARENT,
  ...
  [1] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_TILD,        KC_MINUS,       KC_LPRN,        KC_RPRN,        KC_GRAVE,       KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_EQUAL,       KC_QUOTE,       KC_DQUO,        KC_PLUS,        ES_IEXL, KC_TRANSPARENT,
  ...
  [3] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_Q, KC_W, KC_E, KC_R, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case RGB_SLD:
      ...
      return false;
    /* case INV_QUESTIONMARK: */
    /*     if (record->event.pressed) { */
    /*         printf("\ninv_questionmark pressed.\n"); */
    /*         SEND_STRING(SS_LCTRL(SS_LSFT("u")) "00BF"); */
    /*     } */
    /*     return false; */
    /* case INV_EXCLAMATIONMARK: */
    /*     if (record->event.pressed) { */
    /*         printf("\ninv_exclamationmark pressed.\n"); */
    /*         SEND_STRING(SS_LCTRL(SS_LSFT("u")) "00A1"); */
    /*     } */
    /*     return false; */
  }
